...
# Use environment variables to read credentials
    ...
    try:
        ...
        with ApiClient(configuration) as api_client:
            ...
            if msg_type == 'text':
                ...
                line_bot_api.reply_message(ReplyMessageRequest(reply_token=reply_token, messages=[TextMessage(text='你傳的不是文字訊息喔')]))
